...
server <- function(input, output,session) {
  ...
  output$a1=renderPlot({
    ggplot(react4(), aes(x=factor(ano)))+geom_col(aes(y=i))+ggtitle("Arrecadação segundo ano")+
      labs(x="Ano",y=" ")
  })
  react5=reactive({
